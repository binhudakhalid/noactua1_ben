...
srun -n 160 --exclusive julia --project e1_j_allgather.jl
srun -n 160 --exclusive /scratch/hpc-prf-mpibj/compa/osu-micro-benchmarks-7.0.1/c/mpi/collective/osu_allgather -m 2097152 -i 262144 -f
