...
srun -n 512 --exclusive julia --project e1_j_allgather.jl
srun -n 512 --exclusive /scratch/hpc-prf-mpibj/com/osu-micro-benchmarks-7.0.1/c/mpi/collective/osu_allgather -m 2097152 -i 262144 -f
