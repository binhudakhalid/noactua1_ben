...
srun -n 2 --exclusive julia --project e1_j_bw.jl
srun -n 2 --exclusive /scratch/hpc-prf-mpibj/compa/osu-micro-benchmarks-7.0.1/c/mpi/pt2pt/osu_bw -m 2097152 -i 262144
